...
public class LoginPageObject extends Base {
	 ...
	 */
	public LoginPageObject() {// constructor
		PageFactory.initElements(driver, this); // PageFactory.initElements method
	}
...
// @Findby == driver.findElement()
	...
	@FindBy(xpath = "//h2[text()='My Account']") // h2[text()='My Account']
